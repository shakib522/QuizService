...
public interface QuizFeignInterface {
    ...
    ResponseEntity<List<QuizModel>> getQuestionsFromId(@RequestBody List<Integer> questionIds);

    @PostMapping("question/getScore")
    ResponseEntity<Integer> getScore(@RequestBody List<QuizSubmitResponse> responses);
}
